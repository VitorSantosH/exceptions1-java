...
public class Reservation {
	...
	public Reservation(Integer rooNumber, Date checkIn, Date checkOut) {
		...
		if (checkIn.before(now) || checkOut.before(now)) {
			...
			throw new DomainException("Reservation dates for update must be fyture dates"); 
		}
	...
	public String toString() {
		...
		return "Room " + rooNumber + ", check-in: " + sdf.format(checkIn) + ", check-out: " + sdf.format(checkOut)
				+ ", " + duration() + " nights";
